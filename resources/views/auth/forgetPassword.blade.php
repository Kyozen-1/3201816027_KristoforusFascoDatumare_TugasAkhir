...
<html lang="en">
	...
	<head>
        <base href="../../../../">
		<meta charset="utf-8" />
		<title>Forgot Password | Covid-19 Pontianak</title>
		...
		<link href="{{ asset('metronic/assets/css/pages/login/login-4.css') }}" rel="stylesheet" type="text/css" />
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
					...
					<div class="login-content d-flex flex-column pt-lg-0 pt-12">
						...
						<a href="#" class="login-logo pb-xl-20 pb-15">
							<img src="{{ asset('metronic/assets/media/logos/logo-4.png') }}" class="max-h-70px" alt="" />
						</a>
						<!--end::Logo-->
						<!--begin::Signin-->
						<div class="login-form">
							<form class="form" action="{{route('forget.password.post')}}" method="POST">
								...
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" type="email" placeholder="Email" name="email" id="email_address" autocomplete="off" required autofocus/>
									@if ($errors->has('email'))
				...
				<div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
					<div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom" style="background-image: url(metronic/assets/media/svg/illustrations/login-visual-4.svg);">
						<!--begin::Aside title-->
						<h3 class="pt-lg-40 pl-lg-20 pb-lg-0 pl-10 py-20 m-0 d-flex justify-content-lg-start font-weight-boldest display5 display1-lg text-white">Selalu Ingat
						<br />Password
						<br />Anda !!!</h3>
						<!--end::Aside title-->
					</div>
